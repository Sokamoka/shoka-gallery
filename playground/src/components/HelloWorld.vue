...
<template>
  ...
  <Gallery class="grid grid-rows-6 grid-cols-2 grid-flow-col mt-20" v-slot:default="{ id, src }">
    ...
    <GalleryItem tag="a" href="#" src="https://picsum.photos/id/11/640/640" alt="Lorem ipsum" class="w-32 h-32">
      <img src="https://picsum.photos/id/11/200/200" />
    </GalleryItem>
    <GalleryItem tag="a" href="#" src="https://picsum.photos/id/12/640/640" alt="Lorem ipsum2" class="w-32 h-32">
      <img src="https://picsum.photos/id/12/200/200" />
    </GalleryItem>
    <GalleryItem tag="a" href="#" src="https://picsum.photos/id/13/640/640" alt="Lorem ipsum3" class="w-32 h-32">
